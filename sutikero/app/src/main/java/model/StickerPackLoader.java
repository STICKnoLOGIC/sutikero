...
import static ph.STICKnoLOGIC.aerial.sutikero.provider.StickerContentProvider.ANDROID_APP_DOWNLOAD_LINK_IN_QUERY;
import static ph.STICKnoLOGIC.aerial.sutikero.provider.StickerContentProvider.ANIMATED_STICKER_PACK;
import static ph.STICKnoLOGIC.aerial.sutikero.provider.StickerContentProvider.AVOID_CACHE;
import static ph.STICKnoLOGIC.aerial.sutikero.provider.StickerContentProvider.IMAGE_DATA_VERSION;
import static ph.STICKnoLOGIC.aerial.sutikero.provider.StickerContentProvider.IOS_APP_DOWNLOAD_LINK_IN_QUERY;
import static ph.STICKnoLOGIC.aerial.sutikero.provider.StickerContentProvider.LICENSE_AGREENMENT_WEBSITE;
import static ph.STICKnoLOGIC.aerial.sutikero.provider.StickerContentProvider.PRIVACY_POLICY_WEBSITE;
import static ph.STICKnoLOGIC.aerial.sutikero.provider.StickerContentProvider.PUBLISHER_EMAIL;
import static ph.STICKnoLOGIC.aerial.sutikero.provider.StickerContentProvider.PUBLISHER_WEBSITE;
import static ph.STICKnoLOGIC.aerial.sutikero.provider.StickerContentProvider.STICKER_FILE_EMOJI_IN_QUERY;
import static ph.STICKnoLOGIC.aerial.sutikero.provider.StickerContentProvider.STICKER_FILE_NAME_IN_QUERY;
import static ph.STICKnoLOGIC.aerial.sutikero.provider.StickerContentProvider.STICKER_PACK_ICON_IN_QUERY;
import static ph.STICKnoLOGIC.aerial.sutikero.provider.StickerContentProvider.STICKER_PACK_IDENTIFIER_IN_QUERY;
import static ph.STICKnoLOGIC.aerial.sutikero.provider.StickerContentProvider.STICKER_PACK_NAME_IN_QUERY;
import static ph.STICKnoLOGIC.aerial.sutikero.provider.StickerContentProvider.STICKER_PACK_PUBLISHER_IN_QUERY;
