...
//import com.bumptech.glide.integration.webp.*;
...
public class StickerPackValidator {
    ...
    private static final String APPLE_STORE_DOMAIN = "apps.apple.com";
    ...
    public static void validateSticker(@NonNull Context context, @NonNull final String identifier, @NonNull final Sticker sticker, final boolean animatedStickerPack) throws IllegalStateException {
    ...
    private static void validateStickerFile(@NonNull Context context, @NonNull String identifier, @NonNull final String fileName, final boolean animatedStickerPack) throws IllegalStateException {
        try {
            ...
            throw new IllegalStateException(e.toString()+"\ncannot open sticker file: sticker pack identifier: " + identifier + ", filename: " + fileName, e);
        }
    }
